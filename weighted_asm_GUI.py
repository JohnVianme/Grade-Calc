...
class Ui_MainWindow(object):
    ...
    def grade_assignmets(self):
        ...
        for row in range(rows):
            ...
            # create an assignmet object and add to list of asm
            an_asm = self.add_assignment_weighted(
                assignmets, name, weight, points_earned, possible_possible
            )

        # calculate final grade
        final_grade = self.calc_weighted_grade(assignmets)
        self.show_final_grade(final_grade)

    """
    Show the final grade to the user
    """
    ...
    def add_assignment_weighted(
        self, list_of_asm: List, name, weight, points_earned, points_total
    ):
    ...
    def calc_weighted_grade(self, list_of_weighted_asms: List[weighted_assignment]):
        score = 0
